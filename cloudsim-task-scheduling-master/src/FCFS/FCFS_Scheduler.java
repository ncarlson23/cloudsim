...
public class FCFS_Scheduler {
    ...
    private static void printCloudletList(List<Cloudlet> list) {
        ...
        double totalTime = 0;  // Total time for which all VMs were used
        ...
        Log.printLine("Average Waiting Time: " + dft.format(averageWaitTime));
        Log.printLine("Average Turnaround Time: " + dft.format(averageTurnaroundTime));

        // Calculate and display resource utilization
        double simulationTime = CloudSim.clock();
        double utilization = (totalTime / simulationTime) / vmList.size(); // Assuming uniform VM capacity
        Log.printLine("Resource Utilization: " + dft.format(utilization * 100) + "%");
    }
